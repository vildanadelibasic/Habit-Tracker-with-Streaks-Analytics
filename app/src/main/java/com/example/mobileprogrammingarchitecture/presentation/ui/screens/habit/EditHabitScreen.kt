...
import com.example.mobileprogrammingarchitecture.presentation.ui.screens.habit.components.DetailLabelValueRow
...
@Composable
private fun EditHabitScreenContent(
    habitTitle: String,
...
@Composable
private fun EditHabitScreenCompletedPreview() {
    MobileProgrammingArchitectureTheme {
        EditHabitScreen(
